...
export class UtilityComponent implements OnInit {
  ...
  utilityForm: UntypedFormGroup = new UntypedFormGroup({
    name: new UntypedFormControl('', [Validators.required]),
    type: new UntypedFormControl('', [Validators.required]),
    unit: new UntypedFormControl('', [Validators.required]),
    totalItems: new UntypedFormControl('', [Validators.required]),
    quantityPerItem: new UntypedFormControl(0, [Validators.required]),
    rate: new UntypedFormControl(0, [Validators.required]),
  });
  utilityLength: number = 0;
  updateUtilityFormControls: any = {};
  updateUtilityForm: UntypedFormGroup = new UntypedFormGroup(this.updateUtilityFormControls);
  ...
  constructor(
    ...
    if (!window.localStorage.getItem('pageSizeUtility')) {
      window.localStorage.setItem('pageSizeUtility', '10');
    } else {
      this.pageSize = Number(window.localStorage.getItem('pageSizeUtility'));
    }
  }
  ...
  getInitialUtility() {
    ...
    this.databaseService
      ...
      .finally(() => {
        this.databaseService.getFirstUtilities(this.pageSize).then((docs: any) => {
  ...
  getNextUtilities(event: any) {
    ...
    window.localStorage.setItem('pageSizeUtility', JSON.stringify(this.pageSize));
